        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-b border-gray-800 pb-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-2xl tracking-tight">GigStart</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  <EnvelopeIcon className="h-4 w-4" /> support@gigstart.com
                </li>
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-indigo-400 mb-4">Developer</h3>
              <p className="text-gray-400 text-sm">Mostofa Seum</p>
              <p className="text-gray-500 text-xs mt-1">Full-Stack Developer & CSE Student</p>
            </div>
          </div>
        </div>
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p>© 2026 GigStart. All rights reserved.</p>
