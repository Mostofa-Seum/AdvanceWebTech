    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <form onSubmit={submit} className="bg-white border-2 border-brand-black p-8 shadow-[8px_8px_0px_0px_rgba(43,43,43,1)] space-y-6">
        <div>
          ...
          <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mt-2">Find the UUID on the user's profile or your applicant list.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <input className={inputCls} value={form.reason} onChange={(e) => setForm({ ...form, reason: e.target.value })} placeholder="e.g. Inappropriate behaviour, spam, fraud" />
        </div>
        <div>
      ...
      <p className="text-xs font-bold uppercase tracking-widest text-gray-500">
        ...
        <Link href="/company" className="text-brand-black hover:text-brand-red border-b border-brand-black">Back to dashboard</Link>
      </p>
    </div>
  );
}
